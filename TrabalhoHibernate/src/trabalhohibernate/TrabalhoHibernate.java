...
public class TrabalhoHibernate {
    ...
    public static void main(String[] args) {
        ...
        Editora editorBusca=  em.find(Editora.class, 0);
        
        String consulta1 = "from Editora";
         ...
         Editora edi = em.find(Editora.class, 0);
            System.out.println("*******************************");;
            System.out.println("Nome da Editora: " + editora5.getNome());
            System.out.println("ID da Editora: " + editora5.getCod_edit());  
            System.out.println("******************************");   
        ...
        String consulta0 = "from Autor";
            ...
            for(Object ob: resultado0){
                autor1 = (Autor)ob;
                System.out.println("******************************");
                System.out.println("Nome: " + autor1.getNome());
                System.out.println("ID: " + autor1.getId());
                System.out.println("******************************");
            }
